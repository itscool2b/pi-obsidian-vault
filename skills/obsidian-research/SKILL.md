...
10. Use `mode: "graph"` or `mode: "project"` for bounded query-centered relationship/project summaries; use `mode: "relationships"` for explicit-note relationship summaries.
