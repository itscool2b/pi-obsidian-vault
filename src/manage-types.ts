export type ObsidianManageOperation = "move_note" | "trash_note";
...
export type ObsidianManageNextActionType = "confirm_preview" | "retry_with_from_path" | "retry_with_to_path" | "retry_with_path" | "retry_with_trash_folder" | "choose_different_path" | "create_parent_folder" | "configure_vault_path" | "answer_success" | "stop";
...
export interface ObsidianManageError {
  code: "MISSING_OPERATION" | "UNSUPPORTED_OPERATION" | "FORBIDDEN_OPERATION" | "MISSING_FROM_PATH" | "MISSING_TO_PATH" | "MISSING_PATH" | "UNSAFE_FROM_PATH" | "UNSAFE_TO_PATH" | "UNSAFE_PATH" | "UNSAFE_TRASH_FOLDER" | "SAME_PATH" | "SOURCE_NOT_FOUND" | "SOURCE_NOT_NOTE" | "SOURCE_NOT_MARKDOWN" | "SOURCE_IS_FOLDER" | "SOURCE_NOT_FILE" | "TARGET_EXISTS" | "PARENT_MISSING" | "PARENT_NOT_FOLDER" | "TRASH_FOLDER_NOT_FOLDER" | "TRASH_TARGET_EXISTS" | "VAULT_PATH_REQUIRED" | "VAULT_NOT_ACCESSIBLE" | "VAULT_NOT_WRITABLE" | "MOVE_FAILED" | "TRASH_FAILED";
