...
describe("release documentation and skill guidance", () => {
  it("documents the public surface, operations, workflow, dry-run model, limitations, and recoverable trash", () => {
    ...
    for (const operation of ["search", "context", "graph", "project", "create", "append", "create_folder", "replace_section", "insert_under_heading", "update_frontmatter", "remove_frontmatter", "replace_exact_text", "move_note", "trash_note"]) {
